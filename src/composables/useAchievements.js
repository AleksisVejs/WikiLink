...
const ACHIEVEMENTS = {
  speed_demon:      { id: 'speed_demon',      name: 'Speed Demon',      icon: '&#9889;',    description: 'Win a game in under 30 seconds',     xp: 50,  category: 'speed' },
  lightning:        { id: 'lightning',         name: 'Lightning',        icon: '&#9889;',    description: 'Win a game in under 15 seconds',     xp: 100, category: 'speed' },
  minimalist:       { id: 'minimalist',        name: 'Minimalist',       icon: '&#10024;',   description: 'Win a game in 2 clicks or fewer',    xp: 100, category: 'efficiency' },
  straight_line:    { id: 'straight_line',     name: 'Straight Line',    icon: '&#10145;',   description: 'Win a game in 3 clicks',             xp: 50,  category: 'efficiency' },
  pathfinder:       { id: 'pathfinder',        name: 'Pathfinder',       icon: '&#128270;',  description: 'Win a game in 5 clicks or fewer',    xp: 30,  category: 'efficiency' },
  first_blood:      { id: 'first_blood',       name: 'First Blood',      icon: '&#127942;',  description: 'Win your very first game',            xp: 25,  category: 'milestone' },
  ten_wins:         { id: 'ten_wins',          name: 'Getting Good',     icon: '&#127941;',  description: 'Win 10 games',                       xp: 50,  category: 'milestone' },
  fifty_wins:       { id: 'fifty_wins',        name: 'Veteran',          icon: '&#11088;',   description: 'Win 50 games',                       xp: 100, category: 'milestone' },
  century:          { id: 'century',           name: 'Century',          icon: '&#128081;',  description: 'Win 100 games',                      xp: 200, category: 'milestone' },
  wiki_wanderer:    { id: 'wiki_wanderer',     name: 'Wiki Wanderer',    icon: '&#128214;',  description: 'Play 50 games total',                xp: 50,  category: 'milestone' },
  daily_devotee:    { id: 'daily_devotee',     name: 'Daily Devotee',    icon: '&#128293;',  description: 'Complete 7 daily challenges',         xp: 75,  category: 'dedication' },
  ironman:          { id: 'ironman',           name: 'Ironman',          icon: '&#128170;',  description: 'Complete 30 daily challenges',        xp: 200, category: 'dedication' },
  streak_3:         { id: 'streak_3',          name: 'On a Roll',        icon: '&#128293;',  description: 'Get a 3-win streak in any mode',     xp: 30,  category: 'dedication' },
  streak_10:        { id: 'streak_10',         name: 'Unstoppable',      icon: '&#128293;',  description: 'Get a 10-win streak in any mode',    xp: 100, category: 'dedication' },
  globe_trotter:    { id: 'globe_trotter',     name: 'Globe Trotter',    icon: '&#127758;',  description: 'Win a game in 5 different genres',   xp: 75,  category: 'explorer' },
  sprinter:         { id: 'sprinter',          name: 'Sprinter',         icon: '&#9201;',    description: 'Win 10 sprint games',                xp: 50,  category: 'mode' },
  sharpshooter:     { id: 'sharpshooter',      name: 'Sharpshooter',     icon: '&#127919;',  description: 'Win 10 click-limit games',           xp: 50,  category: 'mode' },
  trendsetter:      { id: 'trendsetter',       name: 'Trendsetter',      icon: '&#128200;',  description: 'Win 5 trending games',               xp: 50,  category: 'mode' },
  close_call:       { id: 'close_call',        name: 'Close Call',       icon: '&#128168;',  description: 'Win a sprint with under 5 seconds left', xp: 75, category: 'special' },
  no_hints:         { id: 'no_hints',          name: 'Pure Skill',       icon: '&#129504;',  description: 'Win 10 games without using any hints', xp: 75, category: 'special' },
  modifier_master:  { id: 'modifier_master',   name: 'Modifier Master',  icon: '&#127918;',  description: 'Win a game with 3+ modifiers active', xp: 100, category: 'special' },
}
